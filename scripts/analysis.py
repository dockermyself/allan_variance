...
if __name__ == "__main__":
    ...
    with open(args.data) as input_file:
        ...
        yaml_file = open(os.path.join(data_dir,"imu.yaml"), "w")

        print("ACCELEROMETER:")
        print("X Velocity Random Walk: {:.5f} m/s/sqrt(s) {:.5f} m/s/sqrt(hr)".format(accel_wn_intercept_x, accel_wn_intercept_x*60))
        print("Y Velocity Random Walk: {:.5f} m/s/sqrt(s) {:.5f} m/s/sqrt(hr)".format(accel_wn_intercept_y, accel_wn_intercept_y*60))
        print("Z Velocity Random Walk: {:.5f} m/s/sqrt(s) {:.5f} m/s/sqrt(hr)".format(accel_wn_intercept_z, accel_wn_intercept_z*60))

        print("X Bias Instability: {:.5f} m/s^2 {:.5f} m/hr^2".format(accel_min_x, accel_min_x*3600*3600))
        print("Y Bias Instability: {:.5f} m/s^2 {:.5f} m/hr^2".format(accel_min_y, accel_min_y*3600*3600))
        print("Z Bias Instability: {:.5f} m/s^2 {:.5f} m/hr^2".format(accel_min_z, accel_min_z*3600*3600))

        print("X Accel Random Walk: {:.5f} m/s^2/sqrt(s)".format(accel_rr_intercept_x))
        print("Y Accel Random Walk: {:.5f} m/s^2/sqrt(s)".format(accel_rr_intercept_y))
        print("Z Accel Random Walk: {:.5f} m/s^2/sqrt(s)".format(accel_rr_intercept_z))
        ...
        fig1.savefig(os.path.join(data_dir,'acceleration.png'), dpi=600, bbox_inches = "tight")
        ...
        print("GYROSCOPE:")
        print("X Angle Random Walk: {:.5f} deg/sqrt(s) {:.5f} deg/sqrt(hr)".format(gyro_wn_intercept_x, gyro_wn_intercept_x * 60))
        print("Y Angle Random Walk: {:.5f} deg/sqrt(s) {:.5f} deg/sqrt(hr)".format(gyro_wn_intercept_y, gyro_wn_intercept_y * 60))
        print("Z Angle Random Walk: {:.5f} deg/sqrt(s) {:.5f} deg/sqrt(hr)".format(gyro_wn_intercept_z, gyro_wn_intercept_z * 60))

        print("X Bias Instability: {:.5f} deg/s {:.5f} deg/hr".format(gyro_min_x, gyro_min_x*60*60))
        print("Y Bias Instability: {:.5f} deg/s {:.5f} deg/hr".format(gyro_min_y, gyro_min_y*60*60))
        print("Z Bias Instability: {:.5f} deg/s {:.5f} deg/hr".format(gyro_min_z, gyro_min_z*60*60))

        print("X Rate Random Walk: {:.5f} deg/s/sqrt(s)".format(gyro_rr_intercept_x))
        print("Y Rate Random Walk: {:.5f} deg/s/sqrt(s)".format(gyro_rr_intercept_y))
        print("Z Rate Random Walk: {:.5f} deg/s/sqrt(s)".format(gyro_rr_intercept_z))
        ...
        fig2.savefig(os.path.join(data_dir,"gyro.png"), dpi=600, bbox_inches = "tight")
